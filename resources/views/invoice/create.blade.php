                ...
                <div class="row justify-content-around mb-4">
                    ...
                    <div class="input-group col-md-2">
                        ...
                        <select class="form-control rounded @error('type') is-invalid @enderror" name="type"
                            ...
                            <option value="3" {{ old('type')=='Credit Card' ? 'selected' : '' }}>Credit Card</option>
                        </select>
                        <span class="text-danger">
                            @error('type')
                            {{ $message }}
                ...
                <tr class="invoice-row">
                    <td class="text-right">
                        <div class="-sm d-flex align-items-center justify-content-around">
                            ...
                            <input type="text" class="form-control -sm item-input invoice_product" name=""
                    ...
                    <td class="text-right">
                        <div class="input-group input-group-sm no-margin-bottom">
                            ...
                            <input type="number" class="form-control calculate-sub invoice_product_price required"
                                name="" aria-describedby="sizing-addon1" placeholder="0.00">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.length > 0) {
                            ...
                            productSuggestionsContainer.html('<div class="product-suggestion error">Product not found</div>');
                        }
                    },

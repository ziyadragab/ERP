                ...
                <div class="row justify-content-around mb-4">
                    ...
                    <div class="input-group col-md-2 ">
                        ...
                        <input type="text" name="number" id="invoice_id"
                            ...
                            placeholder="Invoice Number" aria-describedby="sizing-addon1" value="{{ old('number') }}">
                    ...
                    <div class="col-md-2 no-padding-right">
                        ...
                        <div class="">
                            <div class="input-group date" id="invoice_date">
                                <input type="text" class="form-control required" name="date" value="{{ old('date') }}"
                    ...
                    <div class="col-md-2 no-padding-right">
                        <div class="">
                            ...
                            <div class="input-group date" id="due_date">
                                <input type="text" class="form-control required" value="{{ old('due_date') }}"
            ...
            <div class="col-xs-6">
                <div class="panel panel-default">
                    <div class="panel-heading d-flex align-items-center justify-content-between">
                        ...
                        <select class="form-control @error('customer_id') is-invalid @enderror" id="existingCustomer"
                            name="customer_id">
                            <option value="">~~SELECT~~</option>
...
<script>
    $(document).ready(function () {
        ...
        $('#invoice_table').on('input', '.invoice_product, .invoice_product_qty, .invoice_product_price, .invoice_product_discount', function () {
            ...
            currentRow.find('.invoice_item_code').val(currentRow.find('.invoice_item_code').val()); // Replace this with the actual item code
        });
        ...
        $('#invoice_table').on('input', '.invoice_product', function () {
            ...
            var productSuggestionsContainer = currentProductInput.closest('tr').find('.product-suggestions-container');
                    ...
                    success: function (data) {
                        ...
                        if (data.length > 0) {
                            data.forEach(function (product) {
                                var suggestionDiv = $('<div class="product-suggestion">' + product.item + '</div>');
                                ...
                                suggestionDiv.click(function () {
                                    ...
                                    maxQuantityInput.attr('max', product.quantity);
                                    productSuggestionsContainer.html('');

                                    currentProductInput.closest('tr').find('.invoice_item_code').val(product.item_code);

                                    currentProductInput.closest('tr').find('.invoice_product_qty, .invoice_product_price, .invoice_product_discount').trigger('input');
                                });

                                productSuggestionsContainer.append(suggestionDiv);
                            });
                        } else {
                            productSuggestionsContainer.html('<div class="product-suggestion error"><span class="text-danger">Product not found</span></div>');
                        }
                    },
...
function checkInvalidProducts() {
    ...
    $('.invoice-row').each(function (index, row) {
        ...
        if (productName === '' || itemCode === '') {
            invalidProducts.push(index + 1); // Store the index (row number) of the invalid product
        }
    });
